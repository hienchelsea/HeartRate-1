...
class HeartbeatPresenter(
            ...
            if (System.currentTimeMillis() - timeStart > MEASUREMENT_TIME) {
                ...
                when {
                    MIN_ROLLING > currentRolling -> {
                        ...
                        calculateTheResultOfHeartRate(currentRolling)
                    }
                }
            }
        }
    ...
    private fun calculateTheResultOfHeartRate(currentRolling: Int) {
        val heartAvg = HandlingTheResult.handleResultImage(currentRolling)
